...
class histori_pelepasliaran_noniden extends CI_Model {

function __contruct(){
	parent::__construct();
}

public function jumlahLepasLiar($kode_lk = null){
/*
...
FROM `histori_pelepasliaran_noniden`
 ...
 */
    ...
    $this->db->from("histori_pelepasliaran_noniden");
