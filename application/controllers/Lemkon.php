...
public function getDetilProp(){
    ...
    $judulKolom = array("Nama Lembaga Konservasi","Nama Satwa","Jumlah Jantan", "Jumlah Betina", "Jumlah Unknown");
    $konten = array();
    $i=0;
    $newRow=true;
    foreach ($temp as $row) {
...
public function getSebaranSatwa(){
    ...
    $subCaption = "Terdapat $jumlahSatwa  tersebar";
...
//--------------------------------------------- Transactional Function -------------------------------------
        ...
        public function pelepasliaran_unindef_ctl(){
                ...
                ->display_as("informasi_lk_umum_id_lk", "Nama Lembaga Konservasi")
                ;
        ...
        public function kelahiran_unindef_ctl(){            
            try{
                ...
                $crud->display_as("informasi_lk_umum_kode_lk","Nama Lembaga Konservasi")
                ...
                if($this->hakAkses=="user"){               
                    ...
                    $crud->set_relation("informasi_lk_umum_kode_lk","informasi_lk_umum","nama_lk",array('provinsi_id_prov' => $this->provinsi));    
                    $crud->where("provinsi_id_prov", $this->provinsi);
                }
                else{
                    $crud->set_relation("informasi_lk_umum_kode_lk","informasi_lk_umum","nama_lk");
        ...
        public function pelepasliaran_ctl(){
                ...
                if($this->hakAkses=="user"){               
                   ...
                   $crud->unset_edit();                            
                    ...
                    $crud->unset_edit();  
                    $crud->set_relation("lk_asal_informasi_lk_umum_kode_lk","informasi_lk_umum","nama_lk",array('provinsi_id_prov' => $this->provinsi));    
        ...
        public function kematian_satwa_ctl(){
                ...
                'upload_bap'  );
                $crud->field_type('tindak_lanjut_kematian','dropdown',array('DIKUBUR' => 'Dikubur','OPSET' => 'Opset','DIKREMASI' => 'Dikremasi'));
                $this->load->library('gc_dependent_select');
                if($this->hakAkses=="user"){   
                         $crud->unset_edit();
        ...
        public function informasi_lk_umum_ctl(){
                ...
                $crud->display_as("master_institusi_lk_id_institusi_lk","Institusi LK")
                     ...
                     ->display_as("nama_lk","Nama Lembaga Konservasi")
